...
class SfqlMapper(Generic[T]):
    ...
    _mapper = {
        ...
        'file.newoid': partial(_getFileAttr.__func__, attr="newoid"),
        'file.path': partial(_getFileAttr.__func__, attr='path'),
        'file.type': partial(_getFileAttr.__func__, attr='type'),
        'file.typechar': partial(_getFileAttr.__func__, attr='typechar'),
        'file.newpath': partial(_getFileAttr.__func__, attr='newpath'),
        'file.openflags': partial(_getFileAttr.__func__, attr='openflags'),
        'file.openflags_int': partial(_getFileAttr.__func__, attr='openflags_int'),
        'file.is_open_read': partial(_getFileAttr.__func__, attr='is_open_read'),
        'file.is_open_write': partial(_getFileAttr.__func__, attr='is_open_write'),
        ...
        'network.rbytes': partial(_getNetworkAttr.__func__, attr="rbytes"),
        'network.wbytes': partial(_getNetworkAttr.__func__, attr="wbytes"),
        ...
        'network.iana_number': partial(_getNetworkAttr.__func__, attr="iana_number"),
        'network.gap_time': partial(_getNetworkAttr.__func__, attr="gap_time"),
        ...
        'process.oldexe': partial(_getProcessAttr.__func__, attr='oldexe'),
        'process.oldname': partial(_getProcessAttr.__func__, attr='oldname'),        
