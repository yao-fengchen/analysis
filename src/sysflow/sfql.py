...
class SfqlMapper(Generic[T]):
    ...
    _mapper = {
        ...
        'process.executable': partial(_getProcessAttr.__func__, attr='executable'),
        'process.name': partial(_getProcessAttr.__func__, attr='name'),
        'process.thread.id': partial(_getProcessAttr.__func__, attr='thread.id'),
        ...
        'process.parent.args': partial(_getProcessAttr.__func__, attr='parent.args'),
        'process.parent.command_line': partial(_getProcessAttr.__func__, attr='parent.command_line'),
        'process.parent.executable': partial(_getProcessAttr.__func__, attr='parent.executable'),
        'process.parent.name': partial(_getProcessAttr.__func__, attr='parent.name'),
        'process.parent.thread.id': partial(_getProcessAttr.__func__, attr='parent.thread.id'),
        'process.parent.start': partial(_getProcessAttr.__func__, attr='parent.start'),
        'process.parent.tty': partial(_getProcessAttr.__func__, attr='parent.tty'),
        'process.parent.oid.hpid': partial(_getProcessAttr.__func__, attr='parent.oid.hpid'),
        'process.parent.createTS': partial(_getProcessAttr.__func__, attr='parent.oid.createTS'),

        'parent.args': partial(_getParentAttr.__func__, attr='args'),
        'parent.command_line': partial(_getParentAttr.__func__, attr='command_line'),
        'parent.executable': partial(_getParentAttr.__func__, attr='executable'),
        'parent.name': partial(_getParentAttr.__func__, attr='name'),
        'parent.thread.id': partial(_getParentAttr.__func__, attr='thread.id'),
        'parent.start': partial(_getParentAttr.__func__, attr='start'),
        'parent.tty': partial(_getParentAttr.__func__, attr='tty'),
        'parent.oid.hpid': partial(_getProcessAttr.__func__, attr='oid.hpid'),
        'parent.oid.createTS': partial(_getProcessAttr.__func__, attr='oid.createTS'),
